...
import gestorVentas.facade.ComprasFacade;
...
@FacesConverter(value = "comprasConverter")
public class ComprasConverter implements Converter {

    @Inject
    private ComprasFacade ejbFacade;
